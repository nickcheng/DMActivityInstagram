Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/nickcheng/DMActivityInstagram.git", :tag => "0.0.4" }
  s.description  = <<-DESC
...
[self presentViewController:activityController animated:YES completion:nil];`
                    DESC
  s.homepage     = "https://github.com/nickcheng/DMActivityInstagram"
  s.license      = 'MIT'
  s.author       = { "Cory Alder" => "cory@davander.com" }
  s.source_files = 'DMActivityInstagram/DMActivityInstagram.{h,m}'
  s.resources = "DMActivityInstagram/instagram*.png"
  s.requires_arc = true
end
